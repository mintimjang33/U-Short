...
function buildSystemPrompt({ style, outputLanguage, planningMode, lengthMode, targetChars }) {
...
export async function generateScript({
  ...
  const system = buildSystemPrompt({ style, outputLanguage, planningMode, lengthMode, targetChars });
