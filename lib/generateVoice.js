...
async function synthesizeWithClova({ text, voice, credentials }) {
...
async function synthesizeWithElevenLabs({ text, voice, credentials }) {
 ...
 */
export async function synthesizeVoice({ text, voice, provider, credentials }) {
  ...
  if (resolvedProvider === 'clova') {
    return synthesizeWithClova({ text, voice, credentials });
  }
  if (resolvedProvider === 'elevenlabs') {
    return synthesizeWithElevenLabs({ text, voice, credentials });
  }
